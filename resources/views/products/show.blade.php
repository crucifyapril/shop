            ...
            <div class="flex md:flex-row items-center">
                <div class="md:flex-1 w-1/2 h-1/2 px-4 mb-4 md:mb-0 flex">
                    <div class="w-full h-full rounded-lg bg-gray-300 dark:bg-gray-700 overflow-hidden">
                        <img class="w-full h-full object-cover" src="{{ asset('images/no-image.jpg') }}" alt="Product Image">
                    </div>
                </div>
                <div class="md:flex-1 px-4">
                    ...
                    <div class="flex mb-6">
                        ...
                        <div>
                            ...
                            <span class="text-gray-600 dark:text-gray-300">{{ $product->is_available ? 'В наличии' : 'Нет в наличии' }}</span>
                        </div>
                    </div>
                    <div class="flex mb-4">
                        ...
                        <div class="w-1/2 px-2">
                            <button class="w-full bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-white py-2 px-4 rounded-full font-bold hover:bg-gray-300 dark:hover:bg-gray-600">
                                <a href="{{ route('order.create', ['product_id' => $product->id]) }}">Купить</a>
                            </button>
                        </div>
                    </div>
                </div>
